...
public class ReminderServiceImpl implements ReminderService {
    ...
    public Page<Reminder> showSentReminders(String userId , int pageNo, int pageSize) {
        ...
        return Optional.ofNullable(reminderRepo.findAllByBorrowerId(userId,pageRequest))
    ...
    public SuccessResponse readReminder(String reminderId) {
        return Optional.of(reminderRepo.findById(reminderId)).get()
                .map(reminder -> new SuccessResponse(HttpStatus.OK,String.format("Successfully fetch the reminders for reminderId %s",reminderId), Map.of("reminder", reminder)))
    ...
    public SuccessResponse deleteReminder(String reminderId) {
        ...
        return new SuccessResponse(HttpStatus.OK,"Successfully deleted",Map.of("reminder", reminder));
    }
}
